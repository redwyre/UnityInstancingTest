...
/// </summary>
public class DrawMeshInstancedIndirectArgs5
{
    public const int Size = 5 * sizeof(uint);
    ...
    public static class BufferIndex
    {
        ...
        public const int StartInstanceLocation = 4;
    }
    ...
    public uint StartInstanceLocation { get => Array[BufferIndex.StartInstanceLocation]; set => Array[BufferIndex.StartInstanceLocation] = value; }

    public readonly uint[] Array = new uint[5];
}
